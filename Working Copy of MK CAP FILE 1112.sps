...
IF BUCKET=5 | BUCKET=6 | BUCKET=7 | BUCKET=8  NH_MON=1.
EXECUTE.

SORT CASES BY MONTH (a) RECIPID (a).

SAVE OUTFILE='C:\Documents and Settings\user\Desktop\EdNeuRates2013\LTC_BUCK_ONLY.sav'   /COMPRESSED
/KEEP MONTH RECIPID ADA_MON ALE_MON NH_MON.
...
FREQUENCIES VARIABLES=ADA_MON ALE_MON NH_MON .

SAVE OUTFILE='C:\Documents and Settings\user\Desktop\EdNeuRates2013\LTC_MON.sav'   /COMPRESSED.


AGGREGATE
  /OUTFILE='C:\Documents and Settings\user\Desktop\EdNeuRates2013\MW_CM.sav'
  /BREAK=RECIPID
  /ADA_CM = SUM(ADA_MON) 
  /ALE_CM = SUM(ALE_MON)
  /NH_CM = SUM(NH_MON).

GET FILE='C:\Documents and Settings\user\Desktop\EdNeuRates2013\MW_CM.sav'.
FREQUENCIES VARIABLES=ADA_CM ALE_CM NH_CM.

COMPUTE CommPCT=(ALE_CM + ADA_CM) / (ALE_CM +ADA_CM +NH_CM).
COMPUTE NhPct=(NH_CM) / (ALE_CM+ADA_CM+NH_CM).
EXECUTE.

**** DOES THE FOLLOWING EVEN NEED TO BE DONE?.
**** COMPARE CONTENTS OF MW_CM WITH CPCT_LOOKUP
AGGREGATE
  /OUTFILE='C:\Documents and Settings\user\Desktop\EdNeuRates2013\CPCT_LOOKUP.sav'
  /BREAK=RECIPID
  /CommPct=SUM(CommPct)
  /NhPct=SUM(NhPct).


GET FILE='C:\Documents and Settings\user\Desktop\EdNeuRates2013\CPCT_LOOKUP.sav'.

SORT CASES BY RECIPID (A).

SAVE OUTFILE='C:\Documents and Settings\user\Desktop\EdNeuRates2013\CPCT_LOOKUP.sav'  /COMPRESSED.

GET  FILE='C:\Documents and Settings\user\Desktop\EdNeuRates2013\MCLAIM1112.sav'  .
SORT CASES BY RECIPID (a).

MATCH FILES /FILE=*
 /TABLE='C:\Documents and Settings\user\Desktop\EdNeuRates2013\CPCT_LOOKUP.sav'
 /BY RECIPID.
EXECUTE.
...
FREQUENCIES VARIABLES=bucket mon_num MONTH DISTRICT BUCKET divelig NH_LOC NHD_BUCKET PACE_BUCKET SFY
  /ORDER=ANALYSIS.
